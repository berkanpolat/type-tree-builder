CREATE OR REPLACE FUNCTION public.admin_list_firmalar_v2(p_page integer DEFAULT 1, p_per_page integer DEFAULT 25, p_search text DEFAULT NULL, p_filter_turu text DEFAULT NULL, p_filter_tipi text DEFAULT NULL, p_filter_il text DEFAULT NULL, p_filter_ilce text DEFAULT NULL, p_filter_durum text DEFAULT NULL) RETURNS json LANGUAGE plpgsql SECURITY DEFINER SET search_path TO 'public' AS $body$
