    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-16 flex-1 w-full">
        ...
        <div className="prose prose-sm max-w-none text-foreground space-y-8">
          ...
          <section>
            <h2 className="text-lg font-bold text-foreground mb-3">1. TİCARİ GİZLİLİK VE "MANUİHALE" GÜVENLİĞİ</h2>
            ...
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
              <li><strong className="text-foreground">İhale Bilgileri:</strong> Manuİhale modülü üzerinden açılan ihalelerdeki teknik şartnameler, fiyat teklifleri ve özel stok bilgileri, sadece ihaleyi açan ve teklif veren taraflar (ve yetkili Manufixo adminleri) tarafından erişilebilir.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
              <li>ManuConnect ve diğer modüller üzerinden gerçekleştirilen uygulama içi mesajlaşmalar, taraflar arasında gizlidir.</li>
              <li>Manufixo, sistem güvenliğini sağlamak ve hukuka aykırı içerik denetimi yapmak (spam, dolandırıcılık, taciz vb.) dışında kullanıcı yazışmalarını izlemez veya içeriğini ticari amaçla kullanmaz.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
              <li>ManuPazar veya üyelik paketi alımları sırasında kullanılan kredi kartı ve ödeme bilgileri platformumuz tarafından saklanmaz.</li>
              <li>Tüm ödeme işlemleri, yüksek güvenlik standartlarına sahip (PCI-DSS uyumlu) lisanslı ödeme kuruluşları ve bankalar aracılığıyla, 256-bit SSL sertifikalı güvenli kanallar üzerinden gerçekleştirilir.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-bold text-foreground mb-3">4. MANUKARİYER: ADAY VE İŞVEREN GİZLİLİĞİ</h2>
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
              <li>Adayların özgeçmişleri (CV), sadece başvuruda bulundukları ilgili işverenler tarafından görüntülenebilir.</li>
              <li>İşverenler, aday verilerini sadece işe alım amacıyla kullanmayı ve bu verileri üçüncü şahıslara aktarmamayı kabul ve taahhüt eder.</li>
            </ul>
          </section>
