...
export default function TekPazarTanitim() {
  ...
  const kazanimlar = [
    { icon: Users, title: "Yeni Müşteri Kazanımı" },
    { icon: Eye, title: "Ürün Görünürlüğü" },
    { icon: Store, title: "Dijital Satış Kanalı" },
  ];

  const farklar = [
    { icon: ShoppingBag, title: "Sadece tekstile özel toptan (B2B) ticarete özel yapı" },
    { icon: Search, title: "Ürün bazlı arama ve filtreleme" },
    { icon: MessageSquare, title: "Talep–teklif odaklı satın alma süreci" },
    { icon: MonitorSmartphone, title: "Satıcı ve alıcı için tek panel yönetimi" },
    { icon: ShieldCheck, title: "Güvenli ve şeffaf ticaret altyapısı" },
  ];
      ...
      <section className="relative bg-primary overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-20 md:py-28 text-center">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-primary-foreground leading-tight">
            Tekstilde Toptan Ticaretin<br />
            <span className="text-secondary">Adresi</span>
          </h1>
          <p className="mt-6 text-lg md:text-xl text-primary-foreground/80 font-medium">
            İster Satın, İster Alın. Fırsatları Yakalayın!
          </p>
          ...
          <p className="mt-8 text-primary-foreground/60 text-base md:text-lg max-w-3xl mx-auto leading-relaxed">
            TekPazar, tekstil sektöründe toptan alım ve satım yapan firmaları güvenli, şeffaf ve profesyonel bir dijital ticaret ortamında buluşturur.
      ...
      <section className="bg-primary">
        <div className="max-w-3xl mx-auto px-6 py-14 text-center">
          <p className="text-xl md:text-2xl font-bold text-primary-foreground mb-6">
            Tekstilde toptan ticaretin dijital geleceğine bugünden adım atın.
          </p>
          <Button
            size="lg"
            className="bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold px-8"
