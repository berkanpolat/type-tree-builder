        ...
        <div className="flex-1 space-y-6">
          <div>
            ...
            <div className="flex items-baseline gap-2 flex-wrap">
              ...
              <h1 className="text-3xl font-bold">${fmt(usdPrice)}<span className="text-base font-normal text-white/50">/{period === "aylik" ? "ay" : "yıl"}</span></h1>
              {period === "yillik" && <span className="text-[10px] font-semibold bg-emerald-500/20 text-emerald-300 px-1.5 py-0.5 rounded-full leading-none">%45</span>}
            </div>
