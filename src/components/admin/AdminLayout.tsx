...
import {
  ...
  Gavel, Package, HeadphonesIcon, Building2, Sun, Moon, CreditCard, Activity, Menu
} from "lucide-react";
...
const menuItems = [
  ...
  { label: "Kısıtlamalar", path: "/yonetim/kisitlamalar", icon: Shield, permission: "sikayet_kisitlama" as const },
